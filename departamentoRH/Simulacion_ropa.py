...
class SimulacionRopa:
        ...
        if os.path.exists(ruta_archivo):
            with open(ruta_archivo, 'r') as archivo:
                try:
                    ...
                    claves_requeridas = ["pantalones", "blusas", "ropa_interior"]
        ...
        if os.path.exists(ruta_archivo):
            with open(ruta_archivo, 'r') as archivo:
                try:
                    ...
                    claves_requeridas_costos = ["costo_fijo_diario", "costo_pantalon", "costo_blusa", "costo_ropa_interior"]
                    claves_requeridas_precios = ["precio_pantalon", "precio_blusa", "precio_ropa_interior"]
    ...
    def simular_ventas(self, probabilidades, costos, dias=30):
        ...
        frecuencia_acumulada_pantalones = self.calcular_frecuencia_acumulada(probabilidades["pantalones"])
        frecuencia_acumulada_blusas = self.calcular_frecuencia_acumulada(probabilidades["blusas"])
        frecuencia_acumulada_ropa_interior = self.calcular_frecuencia_acumulada(probabilidades["ropa_interior"])
        ...
        for dia in range(1, dias + 1):
            ...
            tiempo_probadores = random.uniform(5, 15)
            ...
            resultados["tiempo_probadores"].append(tiempo_probadores)
        ...
        resultados["frecuencia_acumulada_pantalones"] = frecuencia_acumulada_pantalones
        resultados["frecuencia_acumulada_blusas"] = frecuencia_acumulada_blusas
        resultados["frecuencia_acumulada_ropa_interior"] = frecuencia_acumulada_ropa_interior
    ...
    def mostrar_resultados_finales(self):
        resultados_finales = {
            ...
            "Promedio de tiempo en probadores (minutos)": sum(self.resultados_simulacion["tiempo_probadores"]) / len(self.resultados_simulacion["dia"])
        }
...
if __name__ == "__main__":
    raiz = Tk()
    raiz.withdraw()
    app = SimulacionRopa(raiz, "Resultados de la Simulación")
    raiz.mainloop()
